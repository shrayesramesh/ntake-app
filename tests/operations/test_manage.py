...
def cli_db(tmp_path, monkeypatch):
    ...
    from app.persistence.database import build_engine, init_schema, make_session_factory
...
def test_main_backup_writes_snapshot(cli_db, tmp_path, capsys):
    ...
    from app.persistence.database import build_engine, make_session_factory
